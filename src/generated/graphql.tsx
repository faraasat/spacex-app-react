...
export type MissionDetailsQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_id' | 'mission_name' | 'launch_date_local' | 'launch_year' | 'launch_success'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
      & Pick<LaunchSite, 'site_id' | 'site_name' | 'site_name_long'>
    )>, links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'article_link' | 'flickr_images' | 'mission_patch' | 'video_link' | 'wikipedia'>
    )>, rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
      & Pick<LaunchRocket, 'rocket_name' | 'rocket_type'>
    )>, ships?: Maybe<Array<Maybe<(
      { __typename?: 'Ship' }
      & Pick<Ship, 'active' | 'attempted_landings' | 'model' | 'name' | 'roles' | 'status' | 'image'>
      & { missions?: Maybe<Array<Maybe<(
        { __typename?: 'ShipMission' }
        & Pick<ShipMission, 'flight' | 'name'>
      )>>> }
    )>>> }
  )> }
);
...
export type MissionListQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'id' | 'mission_id' | 'mission_name' | 'launch_date_utc' | 'launch_success' | 'launch_year' | 'details'>
  )>>> }
);
